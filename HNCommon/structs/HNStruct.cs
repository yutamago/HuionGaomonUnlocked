...
namespace HuionTablet
{
    public class HNStruct
    {
        ...
        {
            public static HNRectRatio DEFAULT = new HNRectRatio() {l = 0.0f, t = 0.0f, b = 1f, r = 1f};
            public float l;
            public float t;
            public float r;
            public float b;
        ...
        public struct HNConfigXML
        {
            ...
            public HNContextEkeys[] ctxEkeys;
        }
