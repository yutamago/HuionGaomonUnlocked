...
namespace HuionTablet.view
{
    public class HuionWorkAreaPictureView : PictureBox
    {
        ...
        {
            get { return this.mScreenshotMaxWidth; }
            set
            {
        ...
        {
            get { return this.mScreenshotMaxHeight; }
            set
            {
        ...
        public int DeviceImageMaxWidth
        {
            ...
            get { return this.mDeviceImageMaxWidth; }
        }
        ...
        public int DeviceImageMaxHeight
        {
            ...
            get { return this.mDeviceImageMaxHeight; }
        }
        ...
        public Bitmap Screenshot
        {
            ...
            get { return this.mScreenshot; }
        }

        public Rectangle ScreenshotRect
        {
            get { return this.mScreenshotRect; }
        }
        ...
        public Bitmap DeviceImage
        {
            set
            {
                ...
                this.mDeviceImage = HuionRender.compressImageWithRate(this.mDeviceImage, this.DeviceImageMaxWidth,
                    this.DeviceImageMaxHeight);
                this.meassure(2);
            }
            get { return this.mDeviceImage; }
        }

        public Rectangle DeviceImageRect
        {
            get { return this.mDeviceImageRect; }
        }
        ...
        public int IntervalSpace
        {
            ...
            get { return this.mIntervalSpace; }
        }
        ...
        public HNStruct.HNRect PenWorkarea
        {
            ...
            get { return this.mPenWorkarea; }
        }

        public Rectangle PenWorkRect
        {
            get { return this.mPenWorkRect; }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (this.mScreenshot != null)
            {
                ...
                e.Graphics.DrawRectangle(pen,
                    new Rectangle(this.mScreenshotRect.X + 1, this.mScreenshotRect.Y + 1,
                        this.mScreenshotRect.Width - 2, this.mScreenshotRect.Height - 2));
            }
            ...
            e.Graphics.DrawRectangle(pen,
                new Rectangle(this.mDeviceImageRect.X + 1, this.mDeviceImageRect.Y + 1, this.mDeviceImageRect.Width - 2,
                    this.mDeviceImageRect.Height - 2));
        }
