...
namespace HuionTablet.view
{
  public class HuionWorkAreaPictureRect : PictureBox
  {
    ...
    public HNStruct.HNRectRatio DeviceRectRatio
    {
      ...
      get
      {
        return this.mDeviceRectRatio;
      }
    }

    private void measureScreenRect()
    {
      this.mScreenDrawRect.X = (int) ((double) this.mScreenRect.X + (double) this.mScreenRect.Width * (double) this.mScreenRectRatio.l);
      this.mScreenDrawRect.Y = (int) ((double) this.mScreenRect.Y + (double) this.mScreenRect.Height * (double) this.mScreenRectRatio.t);
      this.mScreenDrawRect.Width = (int) ((double) this.mScreenRect.Width * ((double) this.mScreenRectRatio.r - (double) this.mScreenRectRatio.l));
      this.mScreenDrawRect.Height = (int) ((double) this.mScreenRect.Height * ((double) this.mScreenRectRatio.b - (double) this.mScreenRectRatio.t));
    ...
    {
      this.mDeviceDrawRect.X = (int) ((double) this.mDeviceRect.X + (double) this.mDeviceRect.Width * (double) this.mDeviceDrawRectRatio.l);
      this.mDeviceDrawRect.Y = (int) ((double) this.mDeviceRect.Y + (double) this.mDeviceRect.Height * (double) this.mDeviceDrawRectRatio.t);
      this.mDeviceDrawRect.Width = (int) ((double) this.mDeviceRect.Width * ((double) this.mDeviceDrawRectRatio.r - (double) this.mDeviceDrawRectRatio.l));
      this.mDeviceDrawRect.Height = (int) ((double) this.mDeviceRect.Height * ((double) this.mDeviceDrawRectRatio.b - (double) this.mDeviceDrawRectRatio.t));
      if (this.DeviceRatioChanged != null)
        this.DeviceRatioChanged((object) this, (EventArgs) RatioEventArgs.getInstance(Utils.rotateRatio(this.mDeviceDrawRectRatio, -this.mDeviceRectRotate)));
      this.Refresh();
    }
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
      ...
      e.Graphics.DrawLine(pen, this.mScreenDrawRect.Left, this.mScreenDrawRect.Top, this.mDeviceDrawRect.Left, this.mDeviceDrawRect.Top);
      e.Graphics.DrawLine(pen, this.mScreenDrawRect.Left, this.mScreenDrawRect.Bottom, this.mDeviceDrawRect.Left, this.mDeviceDrawRect.Bottom);
      e.Graphics.DrawLine(pen, this.mScreenDrawRect.Right, this.mScreenDrawRect.Top, this.mDeviceDrawRect.Right, this.mDeviceDrawRect.Top);
      e.Graphics.DrawLine(pen, this.mScreenDrawRect.Right, this.mScreenDrawRect.Bottom, this.mDeviceDrawRect.Right, this.mDeviceDrawRect.Bottom);
      pen.Dispose();
      Brush brush = (Brush) new SolidBrush(Color.Green);
      int width = 5;
      int height = 5;
      e.Graphics.FillRectangle(brush, new Rectangle(this.mScreenDrawRect.Left, this.mScreenDrawRect.Top, width, height));
      e.Graphics.FillRectangle(brush, new Rectangle(this.mScreenDrawRect.Left, this.mScreenDrawRect.Bottom - height, width, height));
      e.Graphics.FillRectangle(brush, new Rectangle(this.mScreenDrawRect.Right - width, this.mScreenDrawRect.Top, width, height));
      e.Graphics.FillRectangle(brush, new Rectangle(this.mScreenDrawRect.Right - width, this.mScreenDrawRect.Bottom - height, width, height));
      e.Graphics.FillRectangle(brush, new Rectangle(this.mDeviceDrawRect.Left, this.mDeviceDrawRect.Top, width, height));
      e.Graphics.FillRectangle(brush, new Rectangle(this.mDeviceDrawRect.Left, this.mDeviceDrawRect.Bottom - height, width, height));
      e.Graphics.FillRectangle(brush, new Rectangle(this.mDeviceDrawRect.Right - width, this.mDeviceDrawRect.Top, width, height));
      e.Graphics.FillRectangle(brush, new Rectangle(this.mDeviceDrawRect.Right - width, this.mDeviceDrawRect.Bottom - height, width, height));
      brush.Dispose();
    }
    ...
    protected override void OnMouseMove(MouseEventArgs e)
    {
      ...
      if (this.mMouseButton == MouseButtons.Left)
      {
        ...
        if (this.mMouseInRect == this.mScreenDrawRect)
          HuionWorkAreaPictureRect.onRectChanged(ref this.mScreenRectRatio, this.locationType, ratioX, ratioY);
        else if (this.mMouseInRect == this.mDeviceDrawRect)
          HuionWorkAreaPictureRect.onRectChanged(ref this.mDeviceDrawRectRatio, this.locationType, ratioX, ratioY);
        this.mMouseLocation = e.Location;
        if (this.mMouseInRect == this.mScreenDrawRect)
        {
          this.measureScreenRect();
    ...
    private static void onRectChanged(ref HNStruct.HNRectRatio rectRatio, MouseLocationType mouseType, float ratioX, float ratioY)
    {
