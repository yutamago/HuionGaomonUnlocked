...
namespace HuionTablet
{
  ...
  public class HuionDriverDLL
  {
    ...
    [DllImport("User32.dll")]
    public static extern bool EnumDisplayMonitors(IntPtr hdc, IntPtr lprcClip, MonitorInfosCallback lpfnEnum, IntPtr dwData);
    ...
    [DllImport("User32.dll", SetLastError = true)]
    public static extern bool RegisterHotKey(IntPtr hWnd, int id, HuionDriverDLL.KeyModifiers fsModifiers, Keys vk);

    [DllImport("User32.dll", SetLastError = true)]
    public static extern bool UnregisterHotKey(IntPtr hWnd, int id);

    [DllImport("User32.dll")]
    public static extern void mouse_event(HuionDriverDLL.MouseEventFlag flags, int dx, int dy, uint data, UIntPtr extraInfo);
