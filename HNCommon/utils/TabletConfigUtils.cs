...
namespace HuionTablet
{
  public class TabletConfigUtils
  {
    ...
    {
      HNStruct.devTypeString = Marshal.PtrToStringAuto(HuionDriverDLL.hnp_get_tablet_image((HnConst.HNTabletType) HNStruct.globalInfo.tabletInfo.devType));
      ...
      this.SetLayoutPen();
      this.SetConfig(TabletConfigUtils.config);
    }
    ...
    public void SetLayoutTablet(IntPtr pconfig)
    {
      ...
      IntPtr num1 = HuionDriverDLL.hnx_read_layout_tablet(ref HNStruct.globalInfo.tabletInfo, pconfig, coTaskMemAuto);
      HNStruct.HNLayoutTablet hnLayoutTablet = new HNStruct.HNLayoutTablet();
      HNStruct.HNLayoutTablet structure = (HNStruct.HNLayoutTablet) Marshal.PtrToStructure(num1, typeof (HNStruct.HNLayoutTablet));
      ...
      foreach (HNStruct.HNLayoutEkey hnLayoutEkey in TabletConfigUtils.MarshalPtrToStructArray<HNStruct.HNLayoutEkey>(structure.hbtnLayouts, (int) structure.hbtnNum))
      ...
      int num3 = 0;
      foreach (HNStruct.HNLayoutEkey hnLayoutEkey in TabletConfigUtils.MarshalPtrToStructArray<HNStruct.HNLayoutEkey>(structure.sbtnLayouts, (int) structure.sbtnNum))
      ...
      int num4 = 0;
      foreach (HNStruct.HNLayoutEkey hnLayoutEkey in TabletConfigUtils.MarshalPtrToStructArray<HNStruct.HNLayoutEkey>(structure.mekeyLayouts, (int) structure.mekeyNum))
      {
      ...
      int index1 = 0;
      foreach (HNStruct.HNMEkeyName hnmEkeyName in TabletConfigUtils.MarshalPtrToStructArray<HNStruct.HNMEkeyName>(structure.mekeyNames, (int) structure.mekeyNum))
      {
      ...
      int num5 = 0;
      foreach (HNStruct.HNLayoutEkey hnLayoutEkey in TabletConfigUtils.MarshalPtrToStructArray<HNStruct.HNLayoutEkey>(structure.ekLayouts, (int) structure.ekNum))
    ...
    {
      Marshal.PtrToStringAuto(HuionDriverDLL.hnp_get_pen_node((HnConst.HNTabletType) HNStruct.globalInfo.tabletInfo.devType));
      ...
      HNStruct.globalInfo.layoutPen = (HNStruct.HNLayoutPen) Marshal.PtrToStructure(num1, typeof (HNStruct.HNLayoutPen));
