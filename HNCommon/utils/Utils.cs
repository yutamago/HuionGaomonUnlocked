...
namespace HuionTablet.utils
{
    public class Utils
    {
        ...
        {
            get { return CommonStartupPath + Path.GetFileNameWithoutExtension(ExecutablePath) + ".lnk"; }
        }
        ...
        public static string DesktopLinkPath
        {
            get
            {
                return Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\" +
                       Path.GetFileNameWithoutExtension(ExecutablePath) + ".lnk";
            }
        }
        ...
        public static bool isAppRunning()
        {
            ...
            if (processesByName != null && processesByName.Length != 0 && currentProcess != null)
            {
                ...
                {
                    if (currentProcess.Id != process.Id && process.MainModule != null &&
                        ...
                        (!string.IsNullOrEmpty(process.MainModule.FileName) &&
                         currentProcess.MainModule.FileName.Equals(process.MainModule.FileName)))
                        return true;
                }
            }
        ...
        {
            return "huion-luwu".Equals(getArg(args));
        }

        public static bool isStartup(string[] args)
        {
            if (!"huion-hkcu".Equals(getArg(args)))
                return "huion-hklm".Equals(getArg(args));
            return true;
        }
