...
namespace HuionTablet.utils
{
  public class HuionRender
  {
    public static GraphicsPath CreateRoundedRectanglePath(Rectangle rect, int cornerRadius)
    {
      ...
      graphicsPath.AddArc(rect.X + rect.Width - cornerRadius * 2, rect.Y + rect.Height - cornerRadius * 2, cornerRadius * 2, cornerRadius * 2, 0.0f, 90f);
    ...
    public static Bitmap compressImageWithRate(Bitmap bmp, int maxW, int maxH)
    {
      ...
      return HuionRender.resizeImage(bmp, newW, newH);
    }
