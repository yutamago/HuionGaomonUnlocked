...
namespace HuionTablet
{
    public class FormTabletPen : Form, IDestroy
    {
        ...
        public FormTabletPen()
        {
            ...
            this.pictureBoxPressCurve.Size = new Size(DpiHelper.getInstance().DpiMatrix(222),
                DpiHelper.getInstance().DpiMatrix(222));
        ...
        private void PictureBoxDrawLine_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(pen, Utils.getViewCenter((Control) this.btnAbove, 17),
                Utils.getRectCenter(this.penLayouts[2].Rect));
            e.Graphics.DrawLine(pen, Utils.getViewCenter((Control) this.btnBelow, 17),
                Utils.getRectCenter(this.penLayouts[1].Rect));
            pen.Dispose();
        }
        ...
        {
            Point client = this.pictureBoxDrawLine.PointToClient(MousePosition);
