...
namespace Huion
{
    public class TitleBar : UserControl
    {
        ...
        {
            set { this.labelTitle.Enabled = value; }
        }

        public bool ShowSettingsIcon
        {
            get { return this.btnSettings.Visible; }
            set { this.btnSettings.Visible = value; }
        }

        public string SettingsIcon
        {
            get { return this.btnSettings.ImageLocation; }
            set { this.btnSettings.ImageLocation = value; }
        }

        public bool ShowMinimizeBox
        {
            get { return this.btnMinimun.Visible; }
            set { this.btnMinimun.Visible = value; }
        }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            form.Location = new Point(form.Location.X + e.X - this.mDownPoint.X,
                form.Location.Y + e.Y - this.mDownPoint.Y);
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.btnSettings.ErrorImage = (Image) componentResourceManager.GetObject("btnSettings.ErrorImage");
            this.btnSettings.Image = (Image) Resources.settings;
            this.btnSettings.InitialImage = (Image) componentResourceManager.GetObject("btnSettings.InitialImage");
