...
namespace HtmlAgilityPack
{
    public class HtmlEntity
    {
        ...
        static HtmlEntity()
        {
            ...
            _entityValue.Add("yuml", (int) byte.MaxValue);
            _entityName.Add((int) byte.MaxValue, "yuml");
                        ...
                        switch (text[index])
                        {
                            ...
                            case ';':
                                ...
                                else
                                {
                                    ...
                                    {
                                        object obj = (object) _entityValue[stringBuilder2.ToString()];
                                        if (obj == null)
                                        {
                                            stringBuilder1.Append("&" + (object) stringBuilder2 + ";");
                                        }
        ...
        public static HtmlNode Entitize(HtmlNode node)
        {
            ...
            if (htmlNode.HasChildNodes)
                ...
                ((HtmlTextNode) htmlNode).Text = Entitize(((HtmlTextNode) htmlNode).Text, true, true);
            return htmlNode;
        }
        ...
        public static string Entitize(string text, bool useNames, bool entitizeQuotAmpAndLtGt)
        {
            ...
            for (int index1 = 0; index1 < text.Length; ++index1)
            {
                ...
                if (index2 > (int) sbyte.MaxValue || entitizeQuotAmpAndLtGt &&
                    (index2 == 34 || index2 == 38 || (index2 == 60 || index2 == 62)))
                {
                    string str = _entityName[index2];
