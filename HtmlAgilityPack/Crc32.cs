  ...
  public class Crc32
  {
    ...
    public static uint CRC32String(string text)
    {
      ...
      while (length > 0)
      {
        ...
        crc = Crc32.UPDC32((byte) ((uint) num2 & (uint) byte.MaxValue), Crc32.UPDC32((byte) ((uint) num2 >> 8), crc));
        ++num1;
      }
      return ~crc;
    }
    ...
    {
      return Crc32.crc_32_tab[(uint)(((int)crc ^ (int)octet) & (int)byte.MaxValue)] ^ crc >> 8;
    }
  }
}
