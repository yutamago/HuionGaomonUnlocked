...
namespace HtmlAgilityPack
{
    public class Crc32
    {
        ...
        public static uint CRC32String(string text)
        {
            ...
            {
                --length;
                ushort num2 = (ushort) text[length];
                crc = UPDC32((byte) ((uint) num2 & (uint) byte.MaxValue), UPDC32((byte) ((uint) num2 >> 8), crc));
                ++num1;
            }
        ...
        internal uint AddToCRC32(ushort c)
        {
            ...
            this._crc32 = UPDC32((byte) ((uint) c >> 8), this._crc32);
        ...
        {
            return crc_32_tab[(uint) (((int) crc ^ (int) octet) & (int) byte.MaxValue)] ^ crc >> 8;
        }
    }
}