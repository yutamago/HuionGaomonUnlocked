...
namespace HtmlAgilityPack
{
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        {
            get { return this._nametable.GetOrAdd(string.Empty); }
        }
        ...
        {
            get { return this._currentnode.Attributes.Count > 0; }
        }

        public override bool HasChildren
        {
            get { return this._currentnode.ChildNodes.Count > 0; }
        }
        ...
        {
            get { return this._nametable.GetOrAdd(this._currentnode.Name); }
        }
        ...
        {
            get { return (XmlNameTable) this._nametable; }
        }
                ...
                switch (this._currentnode.NodeType)
                {
                    ...
                    default:
                        throw new NotImplementedException("Internal error: Unhandled HtmlNodeType: " +
                                                          (object) this._currentnode.NodeType);
                }
            }
        }
        ...
        internal void InternalTrace(object traceValue)
        {
            ...
            HtmlAgilityPack.Trace.WriteLine(
                string.Format("oid={0},n={1},a={2},v={3},{4}", (object) this.GetHashCode(), (object) str1,
                    (object) this._attindex, (object) str2, traceValue), "N!" + name);
        }
