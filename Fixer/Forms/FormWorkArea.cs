    ...
    public class FormWorkArea : Form, IDestroy
    {
        ...
        private void buttonWhileDisplay_Click(object sender, EventArgs e)
        {
            ...
            this.huionWorkAreaPictrueView1.Screenshot =
                ScreenHelper.getScreenImage((int) HNStruct.globalInfo.userConfig.curScreenIndex, this.monitorInfos);
        }
        ...
        private void FormWorkArea_Load(object sender, EventArgs e)
        {
            ...
            this.huionWorkAreaPictrueView1.setDeviceInfo(HNStruct.globalInfo.layoutTablet.size,
                HNStruct.globalInfo.layoutTablet.penArea, (int) HNStruct.globalInfo.userConfig.rotateAngle);
            ...
            this.textBoxBottom.Text =
                Convert.ToDouble(HNStruct.globalInfo.userConfig.workAreaRatio.b).ToString("0.000");
        ...
        {
            if (HNStruct.globalInfo.userConfig.curScreenIndex < 0U ||
                (long) HNStruct.globalInfo.userConfig.curScreenIndex >= (long) this.displayNum)
                return;
        ...
        private void HuionWorkAreaPictrueView1_Callback(object sender, EventArgs e)
        {
            ...
            workAreaPictureView.Location = new Point((this.Width - workAreaPictureView.Width) / 2,
                workAreaPictureView.Location.Y);
        ...
        {
            if (this.displayNum == 1 && (int) HNStruct.globalInfo.userConfig.curScreenIndex == this.displayNum ||
                (int) HNStruct.globalInfo.userConfig.curScreenIndex > this.displayNum)
        ...
        {
            if (this.comboBoxSelectScreen.SelectedItem == null || (int) HNStruct.globalInfo.userConfig.curScreenIndex ==
                this.comboBoxSelectScreen.SelectedIndex)
                return;
            HNStruct.globalInfo.userConfig.curScreenIndex = (uint) this.comboBoxSelectScreen.SelectedIndex;
            this.huionWorkAreaPictrueView1.Screenshot =
                ScreenHelper.getScreenImage(this.comboBoxSelectScreen.SelectedIndex, this.monitorInfos);
        }

        private void buttonScreenRatio_Click(object sender, EventArgs e)
        {
            HNStruct.RECT screenRect = ScreenHelper.getScreenRect((int) HNStruct.globalInfo.userConfig.curScreenIndex,
                this.monitorInfos);
        ...
        private void btnIdentify_Click(object sender, EventArgs e)
        {
            ...
            for (int index = 0; index < this.displayNum; ++index)
            {
                ...
                new FormIdentify(index + 1, new Point(monitor.Left + 20, monitor.Top + 20),
                    (long) HNStruct.globalInfo.userConfig.curScreenIndex == (long) index).Show();
            }
        ...
        private void InitializeComponent()
        {
            ...
            this.comboBoxSelectScreen.SelectionChangeCommitted +=
                new EventHandler(this.comboBoxSelectScreen_SelectIndexCommitted);
