...
namespace HuionTablet
{
    public class FormSetingBrightness : Form
    {
        ...
        private void addColorPress(List<Monitors> m)
        {
            ...
            {
                this.Invoke((Delegate) new myDelegate(this.addColorPress), (object) m);
            }
            else
            {
                int i = 0;
                ...
                {
                    this.cboxScreenNum.Items.Add(
                        (object) ("No" + (object) i + ": " + monitor.PhysicalMonitor.szPhysicalMonitorDescription));
                    ++i;
                }));
            }
        }
        ...
        private void trackBarB_Scroll(object sender, EventArgs e)
        {
            ...
            Console.WriteLine(gainBVal[1]);
            VcpFeature.setVCPFeature(m[index], HNStruct.VCPFeature.VIDEO_GAIN_BLUE, newVal);
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.cboxScreenNum.SelectionChangeCommitted +=
                new EventHandler(this.cboxScreenNum_SelectionChangeCommitted);
