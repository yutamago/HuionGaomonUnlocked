...
namespace HuionTablet
{
    public class FormSetingBrightness : BaseForm
    {
        ...
        private unsafe void FormSetingBrightness_Load(object sender, EventArgs e)
        {
            ...
            GetDeviceGammaRamp(hdc, (void*) RGBRamp1);
        ...
        private static unsafe bool setBrightness(int brightness)
        {
            ...
            return SetDeviceGammaRamp(hdc, (void*) numPtr1);
        }
        ...
        private void setComboxDisplay()
        {
            ...
            for (int index = 0; index < this.displayNum; ++index)
            {
                ...
                if (this.monitorInfos[index].Flags == 1U)
                    this.cboxScreenNum.Items.Add((object) (ResourceCulture.GetString("FormWorkArea_DisplayText") +
                                                           (object) (index + 1) + ":" +
                                                           ResourceCulture.GetString("FormWorkArea_WidthText") +
                                                           (object) num1 +
                                                           ResourceCulture.GetString("FormWorkArea_HeightText") +
                                                           (object) num2 +
        ...
        {
            setBrightness(this.tBarBrightness.Value);
        }
