...
namespace HuionTablet.Forms
{
    public class keyDisplay : Form
    {
        ...
        public static int keydisplayText
        {
            get { return keyDisplayText; }
            set
            {
                if (keyDisplayText != value)
                    WhenMyValueChange();
                keyDisplayText = value;
            }
        }

        private static event keyDisplayTextChanged keydisplaytextchanged;

        private static void WhenMyValueChange()
        {
            // ISSUE: reference to a compiler-generated field
            if (keydisplaytextchanged == null)
                return;
            // ISSUE: reference to a compiler-generated field
            keydisplaytextchanged();
        }
        ...
        private void keyDisplay_Load(object sender, EventArgs e)
        {
            ...
            keydisplaytextchanged += new keyDisplayTextChanged(this.a);
        ...
        private void a()
        {
            if (this.InvokeRequired)
                this.Invoke((Delegate) new aDelegeat(this.a));
        ...
        private void keyDisplay_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            this.timer3.Dispose();
            // ISSUE: reference to a compiler-generated field
            keydisplaytextchanged = (keyDisplayTextChanged) null;
            keydisplay = (keyDisplay) null;
        }
        ...
        private void DrawRoundRect(Control label, int t)
        {
            ...
            {
                new PointF((float) t, 0.0f), new PointF(width - (float) t, 0.0f), new PointF(width, (float) t),
                new PointF(width, height - (float) t), new PointF(width - (float) t, height),
                new PointF((float) t, height), new PointF(0.0f, height - (float) t), new PointF(0.0f, (float) t)
            };
