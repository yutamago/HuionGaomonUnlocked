...
namespace HuionTablet
{
  public class FormSettings : BaseForm
  {
    ...
    {
      if (FormSettings.mSettingsForm.IsDisposed)
        FormSettings.mSettingsForm = new FormSettings();
      FormSettings.mSettingsForm.mMainFormHandle = mainFormHandle;
      FormSettings.mSettingsForm.isFromToolbar = fromToolbar;
      FormSettings.mSettingsForm.tabIndex = tabIndex;
      FormSettings.mSettingsForm.Show();
      FormSettings.mSettingsForm.Focus();
    }
