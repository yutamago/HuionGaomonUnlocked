...
namespace HuionTablet
{
    public class FormIdentify : Form
    {
        ...
        private object[] SetControlStyleArgs = new object[2]
        {
            (object) ControlStyles.Selectable,
            (object) false
        };
        ...
        public FormIdentify(int identifyNumber, Point location, bool isSelected)
        {
            ...
            this.SetControlStyleMethod = typeof(Button).GetMethod("SetStyle",
        ...
        {
            Thread.Sleep(2000);
            this.Invoke((Delegate) new Void(this.close));
        }
