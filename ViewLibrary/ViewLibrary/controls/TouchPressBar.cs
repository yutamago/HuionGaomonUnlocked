...
namespace HuionTablet.view
{
    public class TouchPressBar : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            e.Graphics.DrawRectangle(this.mPen, this.mBarRect.X, this.mBarRect.Y, this.mBarRect.Width,
                this.mBarRect.Height);
            this.mPen.Color = this.TextColor;
        ...
        protected override void SetBoundsCore(int x, int y, int width, int height, BoundsSpecified specified)
        {
            ...
            if (this.Orientation == Orientation.Horizontal)
                ...
                base.SetBoundsCore(x, y,
                    (int) ((double) num * (double) this.getTextWidth() + (double) this.mBaseHeight), height, specified);
        }
        ...
        private void meassureBarRect()
        {
            ...
            else
            {
                ...
                this.mBarRect.Height -=
                    (int) ((double) this.minValueSize.Height + (double) this.maxValueSize.Height) / 2;
