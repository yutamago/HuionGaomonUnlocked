...
namespace HuionTablet.view
{
    public class HNPanel : Panel
    {
        ...
        {
            get { return this.labelText.ForeColor; }
            set { this.labelText.ForeColor = value; }
        }
        ...
        {
            get { return this.labelText.Width; }
            set { this.labelText.Width = value; }
        }

        public virtual int TextHeight
        {
            get { return this.labelText.Height; }
            set { this.labelText.Height = value; }
        }

        public virtual DockStyle TextDock
        {
            get { return this.labelText.Dock; }
            set { this.labelText.Dock = value; }
        }

        public virtual ContentAlignment TextAlign
        {
            get { return this.labelText.TextAlign; }
            set { this.labelText.TextAlign = value; }
        }
